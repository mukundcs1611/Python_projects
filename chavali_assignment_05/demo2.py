...
#             glViewport (0, int(window_height/2), float(window_width/2), float(window_height/2))
            glViewport(0,320,320,320)
        ...
        if (loop==0):                                                    # // Are We Drawing The First Image?  (Original Texture... Ortho)
            ...
            glTexCoord2f(1.0, 0.0);     glVertex2i(640/2, 0              );
            glTexCoord2f(0.0, 0.0);     glVertex2i(0,              0              );
            glTexCoord2f(0.0, 1.0);     glVertex2i(0,              640/2);
            glTexCoord2f(1.0, 1.0);     glVertex2i(640/2, 640/2);
