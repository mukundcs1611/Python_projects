...
def display_help_text():
    ...
    display_message(text_margin,1-line_number*distance_between_test_lines,"a/A: Radius")
    if flat_shading:
        temp_text="glShadeModel(GL_FLAT)"
    else:
        temp_text="glShadeModel(GL_SMOOTH)"
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"f: flat sha")
    #Display inner_radius
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"i/I: Inner")
    #Display number_of_inner_slices
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"k/K: Number")
    #Display number_of_slices
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"l/L: Number")
    #Display model name
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"m/M: Curren")
    ...
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"o: Lighting")
    #Display front palne
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"p/P: Front")
    #Display material ka and kd
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"r/R: Materi")
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"g/G: Materi")
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"b/B: Materi")
    #Display material ks
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"s/S: Materi")
    #Display material shininess
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"n/N: Materi")
    #Display wireframe
    if wire_frame:
    ...
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"w: Wirefram")
    #Display rotation around x
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"x/X: Rotati")
    #Display rotation around y
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"y/Y: Rotati")
    #Display rotation around z
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"z/Z: Rotati")
    # Display eye location
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"Eye locatio")
    # Display umin, umax, vmin ,vmax
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"umin, umax,")
    # Display eye location
    line_number=line_number+1
    display_message(text_margin,1-line_number*distance_between_test_lines,"Light locat")
    glPopMatrix()
    glMatrixMode(GL_PROJECTION)
    glPopMatrix()
    #glPopAttrib()
...
def display():
    ...
    glEnable(GL_LIGHT0)
    glLightfv(GL_LIGHT0, GL_POSITION, vec(light_position_x, light_position_y, light_position z))
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, vec(material_ambient
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, vec(material_specular_rgb, mate
